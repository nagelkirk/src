...
function.folder <- "C:/Users/brisse11/Desktop/EleTree/src/src_functions/" # set this to the path containing the src_masterfunction.R file. Be sure to end the path with "/"
...
working.dir <- "C:/Users/brisse11/Desktop/EleTree/data/parkdata/" # set this to the folder path that has all the park folders in it. Make sure it has "/" at the end.
...
image.num <- 35 # Manually set this as you go. It represents the point you are classifying. So will be in range of 1-50.
...
# TREES 
tree.bright.thresh <- 1.15
# Change this setting until you like the tree cover 
