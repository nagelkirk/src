...
# Ryan Nagelkirk, 20181211

# The below will need to be modified to handle all the different classifications
# Or it could all be deleted if there is something already better written 


# Will need to loop through park names rather than the complete.MESMAs
# A lot of the code for this might already be in Landsat_v_GT_dataExploration_12parks.R
...
#######  Landsat_v_GT_dataExploration_12parks.R code:
